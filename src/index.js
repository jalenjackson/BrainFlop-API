...
app.use((req, res, next) => {
  var allowedOrigins = ['http://localhost:3000', 'https://brainflopv2-brswnd6tz.now.sh', 'https://www.brainflop.com', 'https://localhost:3000', 'http://127.0.0.1:8081', 'http://localhost:8081'];
